...
exports.list = function(req, res, next) {
    ...
    Uploads.paginate(queryCondition, { page: page, limit: limit ,sort: { date: -1 }}, function(err, result) {
        res.json(result);
    });
