		...
		<el-row :gutter="20" style="margin:0;padding:0">
		  <el-col :span="20" :offset="2">
            <el-row>
                ...
                <el-col :span='20'>
					<Appmusiclist :music="data3"></Appmusiclist>       
                </el-col>
            </el-row>
		  </el-col>
		</el-row>
...
export default {
  ...
  methods: {
	...
	getData(){
		this.axios.get('http://localhost:3000/musics').then((response) => {	
			this.data= response.data
		})
		this.axios.get('http://localhost:3000/cate/4').then((response) => {	
